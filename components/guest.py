        ...
        if question:
            ...
            with st.spinner("Generating answer..."):
                answer = genai.gemini.model.generate_content(
                    f"user name {name} use the data {context} and frame the answer for this question {question} use this template {role_prompt} dont show the template for the output analysis the data properly and produce the corresponding information"
                )
